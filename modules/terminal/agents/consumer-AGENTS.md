...
- **Don't invent option names.** The authoritative list for the revision this
  ...
  `~/.config/opencode/skills/haus/` or `~/.jcode/skills/haus/`, whichever your client uses. It's plain
...
`~/.codex/skills/`, `~/.config/opencode/skills/`, `~/.jcode/skills/` — and they are ordinary
