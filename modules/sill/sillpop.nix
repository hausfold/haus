# sillpop — the bar's popup dismisser. See sillpop.swift for why SketchyBar can't
...
# pounce package upstream): the CLT is already a prerequisite of this rice, and
...
stdenvNoCC.mkDerivation {
  ...
  buildPhase = ''
    runHook preBuild
    /usr/bin/xcrun swiftc -O -o sillpop "$src"
    runHook postBuild
  '';
