...
# Compiled with the system Swift via xcrun, exactly like modules/den's hausax and
# modules/sill's sillpop: the CLT is already a prerequisite of this rice, and
