...
# foundation, `desktop = null;`. This file is the `minimal` desktop exactly as it
# last shipped, so a machine that selected it (`desktop = haus.desktops.minimal;`,
# which is what hausfold.co/minimal.sh once wrote) keeps building unchanged.
