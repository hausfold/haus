...
let
  ...
  holtGuidance = ''
    ...
    from `nebelhaus.claude.globalMd` in this machine's host file
  ...
  assertions = [
    ...
    }
    {
      ...
      message =
        ...
        + "nebelhaus.developer.agents.enable is off, so there is no `holt` to make a worktree, "
  ...
  home-manager.users.${username} =
    ...
    in
    {
      ...
      home.file = {
        ...
        # by the host via nebelhaus.claude.globalMd, with the rice's own `holt`
