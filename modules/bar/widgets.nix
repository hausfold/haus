...
#                block hardcodes everything else.
{
  ...
  # trill IS a haus flake input now, and `haus.notifications.compositor` installs
  # the bundle
  ...
  # the same shape terminal's `scruff hook notify` already has: wired here,
