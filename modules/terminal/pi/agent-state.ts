 ...
 *                           (401/402/403), ONCE per session. An expired key, a
 *                           subscription out of credit, or a local proxy whose
 *                           credential went stale kills every pi lane on the
 *                           machine and says so nowhere. Transient statuses
 *                           (429, 5xx) are deliberately NOT here — pi retries
 *                           them, and a banner per retry is noise.
 *
